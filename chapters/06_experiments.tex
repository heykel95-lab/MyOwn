...
\begin{equation}
\label{eq:lyapunov}
V(\mathbf{e}_p, \dot{\mathbf{p}}_{EE}) =
\underbrace{\tfrac{1}{2}\,\mathbf{e}_p^\top\,\mathbf{K}_p\,\mathbf{e}_p}_{\text{potential energy}}
+
\underbrace{\tfrac{1}{2}\,\dot{\mathbf{p}}_{EE}^\top\,\mathbf{M}_p\,\dot{\mathbf{p}}_{EE}}_{\text{kinetic energy}}
> 0
\end{equation}

$V > 0$ for all $(\mathbf{e}_p, \dot{\mathbf{p}}_{EE}) \neq (\mathbf{0},\mathbf{0})$
...
&= \mathbf{e}_p^\top\,\mathbf{K}_p\,\dot{\mathbf{e}}_p
 + \dot{\mathbf{p}}_{EE}^\top\,\mathbf{M}_p\,\ddot{\mathbf{p}}_{EE}
\notag\\
&= -\,\mathbf{e}_p^\top\,\mathbf{K}_p\,\dot{\mathbf{p}}_{EE}
 + \dot{\mathbf{p}}_{EE}^\top\bigl(\mathbf{K}_p\,\mathbf{e}_p
   - \mathbf{D}_p\,\dot{\mathbf{p}}_{EE}\bigr)
\notag\\
\label{eq:Vdot}
&= -\,\dot{\mathbf{p}}_{EE}^\top\,\mathbf{D}_p\,\dot{\mathbf{p}}_{EE}
\;\leq\; 0
\end{align}

where $\dot{\mathbf{e}}_p = -\dot{\mathbf{p}}_{EE}$ (error decreases when
...
$\dot{\mathbf{p}}_{EE}^\top\mathbf{D}_p\dot{\mathbf{p}}_{EE} \geq 0$.
Strict inequality ($\dot{V} < 0$ for $\dot{\mathbf{p}}_{EE} \neq \mathbf{0}$)
...
the equilibrium $(\mathbf{e}_p, \dot{\mathbf{p}}_{EE}) = (\mathbf{0},\mathbf{0})$ is
\textbf{stable}.
...
permanently (i.e.\ $\dot{\mathbf{p}}_{EE} \equiv \mathbf{0}$) is the
equilibrium itself.
The same argument applies to the rotational subsystem with $\mathbf{e}_R$,
$\mathbf{K}_R$, $\boldsymbol{\omega}_{EE}$, $\mathbf{D}_R$.
...
\caption{Stability verification: Lyapunov function $V(t)$ (left) and its
         time derivative $\dot{V}(t)=-\mathbf{D}_p\dot{p}_{EE}^2\leq0$ (right)
...
\begin{enumerate}
  ...
  \item Activate the impedance controller and record
        \(\mathbf{p}_{EE}(t)\), \(\dot{\mathbf{p}}_{EE}(t)\),
...
\begin{itemize}
  ...
  \item \textbf{Tilt angles} about $\hat{\mathbf{t}}_1$ and $\hat{\mathbf{t}}_2$
        extracted from $\mathbf{R}_{EE}$ vs.\ time: should converge freely to
