...
Only the desired end-effector position and orientation, the stiffness and damping matrices, and the logged signals are changed between experiments.
...
Experiment-specific files additionally contain parameter selection, trajectory or set-point definitions, and CSV logging.
