...
The focus is on the software components required for the thesis experiments rather than on a general-purpose control framework.
These components include reading the robot state, accessing model quantities through libfranka, evaluating the controller within the \(1\,\mathrm{ms}\) Franka Control Interface cycle, mapping Cartesian forces and moments to joint torques, and logging the relevant signals for later evaluation.
...
This structure follows directly from the control law derived in Chapter~2.
...
The listing is shortened to the essential operations.
