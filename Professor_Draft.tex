...
\ProfessorIncludeAbstractfalse
\ProfessorIncludeKurzfassungfalse
\ProfessorIncludeTableOfContentstrue
\ProfessorIncludeReferencesfalse
...
\ProfessorIncludeStateOfTheArtfalse
...
\ifProfessorIncludeSystemSetup
  ...
  \input{chapters/03_system_setup}
\fi

\ifProfessorIncludeSoftwareImplementation
  \setcounter{chapter}{3}
  \input{chapters/04_software_implementation}
\fi
