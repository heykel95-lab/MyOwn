...
one 1\,ms cycle â€” position vector, Jacobian, position-and-orientation error, impedance force,
and joint torques.
...
\begin{equation}
\label{eq:nullspace}
N = \mI_7 - J^+\mJ \in \R{7\times7}
\end{equation}

The diagonal entries of $N$ at $\vq_0$ are:
...
\begin{itemize}
  ...
  \item Joints\,3â€“7 have zero diagonal entries in $N$ at this
...
the projector $N$ is computed only to illustrate the structure of the
redundancy.
Physically, the non-zero entries in $\mathrm{diag}(N)$ at joints
...
$e_R\in\mathbb{R}^3$ (see \cref{subsec:position_orientation_error}).
...
10 & Null-space projector  & $N$   & $\mI_7 - J^+\mJ$ \\
...
Every quantity computed hereâ€”from the DH chain to the final torque vectorâ€”
...
%% =============================================================
%%  APPENDIX B â€“ DATA LOGGING AND ANALYSIS WORKFLOW
%% =============================================================
