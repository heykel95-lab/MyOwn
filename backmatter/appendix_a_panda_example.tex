...
% ─────────────────────────────────────────────────────────────────
\section{Step 5 --- Position and Orientation Error and Impedance Wrench}
\label{app:panda_force}
% ─────────────────────────────────────────────────────────────────

\subsection*{Position and Orientation Error via $\mathbf{T}_d^{-1}\mathbf{T}_{EE}$}

Suppose the desired position and orientation are $\mathbf{T}_d$ with $\mathbf{R}_d=\mathbf{I}_3$
and $\mathbf{p}_d=[0.136,\;0.545,\;0.395]^\top\,\mathrm{m}$
(the home position shifted $20\,\mathrm{mm}$ in $x$).
The current position and orientation at $\vq_0$ are $\mathbf{T}_{EE}$ with $\mathbf{R}_{EE}$ (from \abbr{FK})
