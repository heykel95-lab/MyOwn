...
It validates the compliance law $d_{ss} = F_n/k_{\mathrm{stiff}}$
from \cref{eq:ss_error}.
...
three stiffness values, runs the wall controller for 5\,s each, and
...
Critical damping & $D_n=2\sqrt{k}$ & $28.3,\ 44.7,\ 63.2$ & Ns/m \\
