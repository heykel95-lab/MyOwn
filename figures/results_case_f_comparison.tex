...
\begin{axis}[
    ...
    xlabel={Commanded CoC Displacement [mm]},
    ylabel={Set-Up Rotation About \(t_1\), \(\gamma_{t_1}\) [\(^\circ\)]},
    % At \footnotesize the legend box reached back to about -22 mm and the
    % rising tangential series ran through it. \scriptsize keeps it inside the
    ...
    legend style={font=\scriptsize, draw=gray!50, fill=white,
                  ...
                  at={(0.985,0.03)}, anchor=south east},
...
\addplot[blue!55!black, mark=square,
  ...
  (20,7.55)  +- (0,0.03)
  (40,7.60)  +- (0,0.04)};
\addlegendentry{Tool-Axis Displacement, \(r_c\parallel\) Tool Axis}
