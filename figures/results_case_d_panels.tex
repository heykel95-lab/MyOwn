% Case-D tangential lever variation for both signs of the initial deviation
% about t_1. Error bars show the sample standard deviation of the three
...
\pgfplotsset{
  every axis/.append style={
    ...
    % occupies the empty band above 9 deg.
