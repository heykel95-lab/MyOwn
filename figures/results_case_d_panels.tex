...
\addplot[black, mark=o, error bars/.cd, y dir=both, y explicit] coordinates {
  ...
  (40,7.87) +- (0,0.01)};
\addlegendentry{Achieved Initial Angular Offset, \(\theta_{\mathrm{ach},t_1}=9.32^\circ\)}
\addplot[blue!55!black, mark=square, error bars/.cd, y dir=both, y explicit] coordinates {
  ...
  (40,-0.09) +- (0,0.01)};
\addlegendentry{Achieved Initial Angular Offset, \(\theta_{\mathrm{ach},t_1}=-9.36^\circ\)}
