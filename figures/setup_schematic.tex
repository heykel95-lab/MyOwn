...
\begin{tikzpicture}[
    font=\small,
    wood/.style={draw=brown!70!black, fill=brown!22},
    woodDark/.style={draw=brown!70!black, fill=brown!42},
    metal/.style={draw=gray!70!black, fill=gray!25},
    robot/.style={draw=gray!60, fill=gray!8},
...
\begin{scope}
  ...
  \draw[fill=gray!12, draw=gray!50] (-3.20,1.72) rectangle (3.20,2.18);
...
\begin{scope}[xshift=9.4cm, yshift=0.15cm]
  ...
  \begin{scope}[shift={(C)}, rotate=-4]
    ...
    \node[font=\scriptsize] at (0.62,0.18) {tool};
  \end{scope}
  ...
  % ---- the compliance centre and its lever ---------------------------------
  % Placed clear of the plane and of the tool face; the measurements say its
  % height is immaterial, so the drawing is free to put it where it reads.
  \coordinate (P) at (1.55,3.28);
  \draw[blue!65!black, thin, {Latex[length=1.6mm]}-{Latex[length=1.6mm]}] (C) -- (P);
  ...
  \node at (0.1,0.60) {(b) contact geometry};
\end{scope}
