...
% in the sign of r_{c,t}: the tool inclination and the force are identical, and
...
% ============ (a) displacement selected from the deviation direction ========
\begin{scope}
...
% ============ (b) displacement with the opposite sign =======================
...
% ---- the complete commanded moment, stated once under the pair -----------
\node[lbl] at (3.0,-1.50)
  {$f_n=F_n n_s$,\qquad $m=m_R+r_c\times f$};
