...
% The two offsets drawn are the same rigid offset: p_TCP,clearance above
% p_Tool,clearance, and p_d above p_Tool,d. Drawing both makes the construction
% of Equation (3.23) visible, so neither segment carries a label: the product
% R_EE,clearance r_Tool,EE was the longest item in the picture and Equation
% (3.16) states the relation on the same page.
...
\begin{tikzpicture}[
  ...
  \node[lbl, anchor=west] at (2.66,2.15) {$p_{\mathrm{TCP,clearance}}$};
  ...
  \node[lbl, anchor=east] at (2.18,0.82) {$p_{\mathrm{Tool,clearance}}$};
