...
\begin{tikzpicture}[
    scale=1.15,
    reference/.style={red!75!black, line width=1.1pt, densely dashed},
...
% Shared legend.
\draw[reference] (-4.15,2.20) -- (-3.40,2.20);
\node[lbl, red!75!black, anchor=west] at (-3.25,2.20)
  {Configured surface};
\draw[physical] (-0.70,2.20) -- (0.05,2.20);
\node[lbl, blue!70!black, anchor=west] at (0.20,2.20)
  {Physical surface};
\draw[tool] (2.85,2.20) -- (3.60,2.20);
\node[lbl, green!55!black, anchor=west] at (3.75,2.20)
  {Tool face};
