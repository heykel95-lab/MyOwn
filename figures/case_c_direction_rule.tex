...
% tangents, the commanded rotation vector theta_cmd, and the tangential lever
    ...
    10.2/90/1/0.95/{$+90^\circ$}/{about $t_2$}}
{
  \begin{scope}[xshift=\dx cm]
    ...
    \node[lbl, red] at (\ua:1.42) {$\theta_{\mathrm{cmd}}$};
    ...
    % theta_cmd label instead of sitting on it.
    ...
    % The marker spans the quadrant from theta_cmd to r_c,t, so the scope is
